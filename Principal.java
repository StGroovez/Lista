                    ...
                    if (listaSeleccionada >= 1 && listaSeleccionada <= listas.length) {
                        ...
                        switch (opcionModificacion) {
                            case 1:
                                ...
                                System.out.println("Ingresa el index del primer elemento que deseas intercambiar:");
                                int indiceElemento1 = Lista.validacionNumero();
                                System.out.println("Ingresa el index del segundo elemento que deseas intercambiar:");
                            ...
                            case 2:
                                listas[listaSeleccionada - 1].getNombre();
                                listas[listaSeleccionada - 1].mostrarElementos();
                                System.out.println("Ingresa el index del elemento que deseas borrar:");
